...
module OV7670Init (index_i, data_o);
   ...
   always @* begin
      (* parallel_case *) case(index_i)
         ...
         6'd2 : data_o = {16'h1214, 1'b1};   // COM7     Set RGB (06 enables color bar overlay).
  
         6'd3 : data_o = {16'h1180, 1'b1};   // CLKRC    Use external clock directly. //doubling
         //6'd3 : data_o = {16'h1100, 1'b1};   // CLKRC    Use external clock directly. //not-doubling
         6'd4 : data_o = {16'h0C00, 1'b1};   // COM3     Disable DCW & scalling. + RSVD bits.
         //6'd4 : data_o = {16'h0C08, 1'b1};   // COM3     Disable DCW & scalling. + RSVD bits. : 08: enable scaling
         6'd5 : data_o = {16'h3E00, 1'b1};   // COM14    Normal PCLK.
         //6'd5 : data_o = {16'h3E08, 1'b1};   // COM14    Normal PCLK, 08: MANUAL SCALING ENABLE
         6'd6 : data_o = {16'h8C02, 1'b1};   // RGB444   Enable RGB444
                                            /*
                                            Bit[7:2]: Reserved
         ...
         6'd8 : data_o = {16'h40d0, 1'b1};   // COM15    Set RGB565 full value range
                                                         ...
                                                         Bit[3:0]: Reserved
                                                         */
         6'd9 : data_o = {16'h3a00, 1'b1};   // TSLB     Don't set window automatically. + RSVD bits.
         6'd10: data_o = {16'h1418, 1'b1};   // COM9     Maximum AGC value x4. Freeze AGC/AEC. + RSVD bits.
         
         6'd11: data_o = {16'h4f80, 1'b1};   // MTX1     Matrix Coefficient 1
         6'd12: data_o = {16'h5080, 1'b1};   // MTX2     Matrix Coefficient 2
         6'd13: data_o = {16'h5100, 1'b1};   // MTX3     Matrix Coefficient 3
         6'd14: data_o = {16'h5222, 1'b1};   // MTX4     Matrix Coefficient 4
         6'd15: data_o = {16'h535e, 1'b1};   // MTX5     Matrix Coefficient 5
         6'd16: data_o = {16'h5480, 1'b1};   // MTX6     Matrix Coefficient 6
         /*
         ...
         */         
         ...
         6'd19: begin data_o = {16'h1100, 1'b1};   // CLKRC    Use external clock directly.
                    data_o = {16'h1504, 1'b1}; //vsync up with rising edge
                    
                end
         
         6'd20: data_o = {16'h1714, 1'b1};   // HSTART
         ...
         6'd23: data_o = {16'h1902, 1'b1};   // VSTART   VSYNC start high 8 bits.
         6'd24: data_o = {16'h1A7a, 1'b1};   // VSTOP    VSYNC stop high 8 bits.
         ...
         */
         ...
         6'd30: data_o = {16'h690f, 1'b1};   // GFIX     Fix Gain Control? No.    
